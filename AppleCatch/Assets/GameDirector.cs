...
public class GameDirector : MonoBehaviour {
	...
	void Update() {
        ...
        else if (5 <= this.time && this.time < 10 && 1000 <= this.point && this.point < 10000)
        {
            this.generator.GetComponent<ItemGenerator>().SetParameter(0.2f, -0.08f, 0);
        }

        else if (5 <= this.time && this.time < 10 && 0 <= this.point && this.point < 1000)
        {
            this.generator.GetComponent<ItemGenerator>().SetParameter(0.7f, -0.06f, 6);
        }
